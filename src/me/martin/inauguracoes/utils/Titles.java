package me.sailez.inauguracoes.utils;
	...
	public void updateTimes(Player player) {
		if (Titles.packetTitle != null) {
			try {
				...
				Method sendPacket = getMethod(connection.getClass(),
						"sendPacket");
				Object packet = Titles.packetTitle.getConstructor(
						new Class[] { Titles.packetActions, chatBaseComponent,
		...
		if (Titles.packetTitle != null) {
			try {
				...
				Object packet = Titles.packetTitle
						.getConstructor(
								new Class[] { Titles.packetActions,
